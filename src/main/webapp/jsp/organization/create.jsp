...
<html>
    ...
    <body>
        <div class="container" >
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="commandModel" method="POST" action="${pageContext.request.contextPath}/organization/create">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">  
                        <sf:select class="form-control" id="selectLocation" path="locationId">
