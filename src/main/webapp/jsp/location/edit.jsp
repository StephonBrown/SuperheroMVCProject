...
<html>
    ...
    <body>
        <div class="container" >
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="commandModel" method="POST" action="${pageContext.request.contextPath}/location/edit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" >
                      <sf:input type="number" step=".00000001" id="add-location-longitude" class="form-control" path="longitude" placeholder="30.000000"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" >
                      <sf:input type="number" step=".00000001" id="add-location-latitude" class="form-control" path="latitude" placeholder="30.000000"/>
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <button class="btn btn-primary" type="submit" >Edit Location</button>
                    </div>
                </div>
            </sf:form>
           </sec:authorize>
