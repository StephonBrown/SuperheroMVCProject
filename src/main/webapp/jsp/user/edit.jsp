<%-- 
    Document   : edit
    Created on : Aug 13, 2018, 4:28:46 PM
    Author     : sbrown6
--%>
    ...
    <body>
        <div class="container" >
           ...
           <sec:authorize access="hasRole('ROLE_ADMIN')">
            <sf:form class="form-horizontal" role="form" modelAttribute="commandModel" method="POST" action="${pageContext.request.contextPath}/user/edit">
