...
<html>
    ...
    <body>
        <div class="container" >
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="commandModel" method="POST" action="${pageContext.request.contextPath}/sighting/create">
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <button class="btn btn-primary" type="submit" >Create Sighting</button>
                    </div>
                </div>
            </sf:form>
            </sec:authorize>
