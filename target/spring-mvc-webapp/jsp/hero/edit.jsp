...
<html>
    ...
    <body>
        <div class="container" >
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="commandModel" method="POST" action="${pageContext.request.contextPath}/hero/edit">
                ...
                <div class="form-group">
                    <label for="add-rating" class="col-md-4 control-label">Super Powers</label>
                    <div class="col-md-8">  
